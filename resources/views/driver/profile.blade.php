  ...
  <div class="profile-header">
    ...
    <div class="profile-badges">
      @if($user->is_verified)
        <span class="verified-badge">
          <i class="fa-solid fa-circle-check"></i> Verified Driver
        </span>
      @else
      ...
      @endif
      <span class="driver-badge" style="background:var(--clr-gold-mid);color:var(--clr-gray-900)">
    ...
    <div class="profile-stats">
      <div class="profile-stat">
        <div class="profile-stat-val">{{ $totalTrips ?? 0 }}</div>
        <div class="profile-stat-lbl">Trips</div>
      </div>
      <div class="profile-stat">
        <div class="profile-stat-val">{{ $totalPassengers ?? 0 }}</div>
        <div class="profile-stat-lbl">Passengers</div>
      </div>
      <div class="profile-stat">
  ...
  <div class="profile-section-card">
    ...
    <div class="profile-section-body">
      <form id="profileForm" data-loading>
        ...
        <!-- Vehicle details -->
        <h4 class="mt-4 mb-3 text-sm fw-bold text-secondary-c" style="letter-spacing:var(--ls-wider);text-transform:uppercase">
          <i class="fa-solid fa-car me-1"></i> Vehicle Details
        </h4>

        <div class="form-group-c">
          <label class="form-label-c" for="profileVehicleModel">Vehicle Model</label>
          <div class="input-icon-wrap">
            <i class="fa-solid fa-car-side input-icon-left"></i>
            <input
              type="text"
              id="profileVehicleModel"
              class="input-chariot has-icon-left"
        ...
        <div class="form-group-c">
          <label class="form-label-c" for="profileVehicleColor">Vehicle Color</label>
          <div class="input-icon-wrap">
            <i class="fa-solid fa-palette input-icon-left"></i>
            <input
              type="text"
              id="profileVehicleColor"
              class="input-chariot has-icon-left"
        ...
        <div class="form-group-c">
          <label class="form-label-c" for="profilePlateNumber">Plate Number</label>
          <div class="input-icon-wrap">
            <i class="fa-solid fa-rectangle-ad input-icon-left"></i>
            <input
              type="text"
        ...
        <div class="form-group-c">
          <label class="form-label-c" for="profileTotalSeats">Total Passenger Seats</label>
          <div class="input-icon-wrap">
            <i class="fa-solid fa-chair input-icon-left"></i>
            <input
              type="number"
              id="profileTotalSeats"
              class="input-chariot has-icon-left"
    ...
    <div class="profile-section-body">
      <div class="d-flex flex-column gap-3">
        ...
        <div class="d-flex justify-content-between align-items-center">
          ...
          <span class="driver-badge" style="background:var(--clr-gold-mid);color:var(--clr-gray-900)">{{ ucfirst($user->role) }}</span>
        </div>
        <div class="d-flex justify-content-between align-items-center">
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  form?.addEventListener('submit', async function (e) {
    ...
    const body = {
      ...
      total_seats:    parseInt(document.getElementById('profileTotalSeats').value.trim(), 10),
    };

    Chariot.Buttons.setLoading(saveBtn, true);

    try {
      await Chariot.Util.put('/driver/profile', body);
